module.exports =
__NEXT_REGISTER_PAGE('/counter', function() {
          var comp =
      webpackJsonp([4],{
...
var t=Object.assign||function(e){for(var t,r=1,n=arguments.length;r<n;r++)for(var o in t=arguments[r])Object.prototype.hasOwnProperty.call(t,o)&&(e[o]=t[o])
return e}
function r(e,t,r,n){return new(r||(r=Promise))(function(o,i){function a(e){try{u(n.next(e))}catch(e){i(e)}}function c(e){try{u(n.throw(e))}catch(e){i(e)}}function u(e){e.done?o(e.value):new r(function(t){t(e.value)}).then(a,c)}u((n=n.apply(e,t||[])).next())})}function n(e,t){var r,n,o,i,a={label:0,sent:function(){if(1&o[0])throw o[1]
return o[1]},trys:[],ops:[]}
...
return{value:i[0]?i[1]:void 0,done:!0}}([i,c])}}}var o=function(e){},i=function(e){return{config:e,validate:o,create:function(e){e.onInit&&e.onInit.call(this)
var t={}
...
e[c]&&(t[c]=e[c].bind(this))}return t}}},a={exposed:{storeDispatch:function(e,t){console.warn("Warning: store not yet loaded")},storeGetState:function(){console.warn("Warning: store not yet loaded")},dispatch:function(e){return this.storeDispatch(e)},createDispatcher:function(e,t){var o=this
return function(payload,meta){return r(o,void 0,void 0,function(){var r
return n(this,function(n){return r={type:e+"/"+t},void 0!==payload&&(r.payload=payload),void 0!==meta&&(r.meta=meta),[2,this.dispatch(r)]})})}}},onStoreCreated:function(e){return this.storeDispatch=e.dispatch,this.storeGetState=e.getState,{dispatch:this.dispatch}},onModel:function(e){if(this.dispatch[e.name]={},e.reducers)for(var t=0,r=Object.keys(e.reducers);t<r.length;t++){var n=r[t]
this.validate([[!!n.match(/\/.+\//),"Invalid reducer name ("+e.name+"/"+n+")"],["function"!=typeof e.reducers[n],"Invalid reducer ("+e.name+"/"+n+"). Must be a function"]]),this.dispatch[e.name][n]=this.createDispatcher.call(this,e.name,n)}}},c={exposed:{effects:{}},onModel:function(e){if(e.effects)for(var t="function"==typeof e.effects?e.effects(this.dispatch):e.effects,r=0,n=Object.keys(t);r<n.length;r++){var o=n[r]
this.validate([[!!o.match(/\//),"Invalid effect name ("+e.name+"/"+o+")"],["function"!=typeof t[o],"Invalid effect ("+e.name+"/"+o+"). Must be a function"]]),this.effects[e.name+"/"+o]=t[o].bind(this.dispatch[e.name]),this.dispatch[e.name][o]=this.createDispatcher.call(this,e.name,o),this.dispatch[e.name][o].isEffect=!0}},middleware:function(e){var t=this
return function(o){return function(i){return r(t,void 0,void 0,function(){return n(this,function(t){switch(t.label){case 0:return i.type in this.effects?[4,o(i)]:[3,2]
case 1:return t.sent(),[2,this.effects[i.type](i.payload,e.getState(),i.meta)]
case 2:return[2,o(i)]}})})}}}}
var u=function(e){var t,r=e.Symbol
return"function"==typeof r?r.observable?t=r.observable:(t=r("observable"),r.observable=t):t="@@observable",t}("undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global: true?module:Function("return this")()),s={INIT:"@@redux/INIT"+Math.random().toString(36).substring(7).split("").join("."),REPLACE:"@@redux/REPLACE"+Math.random().toString(36).substring(7).split("").join(".")},d="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},f=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t]
...
return r(l)(e,t)}if("function"!=typeof e)throw Error("Expected the reducer to be a function.")
var o=e,i=t,a=[],c=a,f=!1
function h(){c===a&&(c=a.slice())}function p(){if(f)throw Error("You may not call store.getState() while the reducer is executing. The reducer has already received the state as an argument. Pass it down from the top reducer instead of reading it from the store.")
return i}function y(e){if("function"!=typeof e)throw Error("Expected the listener to be a function.")
if(f)throw Error("You may not call store.subscribe() while the reducer is executing. If you would like to be notified after the store has been updated, subscribe from a component and invoke store.getState() in the callback to access the latest state. See https://redux.js.org/api-reference/store#subscribe(listener) for more details.")
var t=!0
return h(),c.push(e),function(){if(t){if(f)throw Error("You may not unsubscribe from a store listener while the reducer is executing. See https://redux.js.org/api-reference/store#subscribe(listener) for more details.")
t=!1,h()
var r=c.indexOf(e)
c.splice(r,1)}}}function v(e){if(!function(e){if("object"!==(void 0===e?"undefined":d(e))||null===e)return!1
...
try{f=!0,i=o(i,e)}finally{f=!1}for(var t=a=c,r=0;r<t.length;r++){(0,t[r])()}return e}return v({type:s.INIT}),(n={dispatch:v,subscribe:y,getState:p,replaceReducer:function(e){if("function"!=typeof e)throw Error("Expected the nextReducer to be a function.")
o=e,v({type:s.REPLACE})}})[u]=function(){var e,t=y
return(e={subscribe:function(e){if("object"!==(void 0===e?"undefined":d(e))||null===e)throw new TypeError("Expected the observer to be an object.")
function r(){e.next&&e.next(p())}return r(),{unsubscribe:t(r)}}})[u]=function(){return this},e},n}function h(e,t){var r=t&&t.type
return"Given "+(r&&'action "'+r+'"'||"an action")+', reducer "'+e+'" returned undefined. To ignore an action, you must explicitly return the previous state. If you want this reducer to hold no value, you can return null instead of undefined.'}function p(e){for(var t=Object.keys(e),r={},n=0;n<t.length;n++){var o=t[n]
"function"==typeof e[o]&&(r[o]=e[o])}var i=Object.keys(r),a=void 0
try{!function(e){Object.keys(e).forEach(function(t){var r=e[t]
if(void 0===r(void 0,{type:s.INIT}))throw Error('Reducer "'+t+"\" returned undefined during initialization. If the state passed to the reducer is undefined, you must explicitly return the initial state. The initial state may not be undefined. If you don't want to set a value for this reducer, you can use null instead of undefined.")
...
if(a)throw a
for(var n=!1,o={},c=0;c<i.length;c++){var u=i[c],s=e[u],d=(0,r[u])(s,t)
if(void 0===d){var f=h(u,t)
throw Error(f)}o[u]=d,n=n||d!==s}return n?o:e}}function y(e,t){return function(){return t(e.apply(this,arguments))}}function v(){for(var e=arguments.length,t=Array(e),r=0;r<e;r++)t[r]=arguments[r]
return 0===t.length?function(e){return e}:1===t.length?t[0]:t.reduce(function(e,t){return function(){return e(t.apply(void 0,arguments))}})}function b(){for(var e=arguments.length,t=Array(e),r=0;r<e;r++)t[r]=arguments[r]
return function(e){return function(){for(var r=arguments.length,n=Array(r),o=0;o<r;o++)n[o]=arguments[o]
var i=e.apply(void 0,n),a=function(){throw Error("Dispatching while constructing your middleware is not allowed. Other middleware would not be applied to this dispatch.")},c={getState:i.getState,dispatch:function(){return a.apply(void 0,arguments)}},u=t.map(function(e){return e(c)})
return a=v.apply(void 0,u)(i.dispatch),f({},i,{dispatch:a})}}}var m=Object.freeze({createStore:l,combineReducers:p,bindActionCreators:function(e,t){if("function"==typeof e)return y(e,t)
if("object"!==(void 0===e?"undefined":d(e))||null===e)throw Error("bindActionCreators expected an object or a function, instead received "+(null===e?"null":void 0===e?"undefined":d(e))+'. Did you write "import ActionCreators from" instead of "import * as ActionCreators from"?')
for(var r=Object.keys(e),n={},o=0;o<r.length;o++){var i=r[o],a=e[i]
"function"==typeof a&&(n[i]=y(a,t))}return n},applyMiddleware:b,compose:v,__DO_NOT_USE__ActionTypes:s}),g=function(e){return e.includes("/")},w=function(e){void 0===e&&(e={})
...
return!t&&"object"==typeof window&&window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__?window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__(r):v}
var x=[a,c],O=function(){function e(e){var t=this
this.plugins=[],this.config=e,this.pluginFactory=i(e)
...
o[e]&&t(o[e])}},e.prototype.getModels=function(e){return Object.keys(e).map(function(r){return t({name:r},e[r],{reducers:e[r].reducers||{}})})},e.prototype.addModel=function(e){this.forEachPlugin("onModel",function(t){return t(e)})},e.prototype.init=function(){var e=this
this.models=this.getModels(this.config.models)
for(var r=0,n=this.models;r<n.length;r++){this.addModel(n[r])}var o=function(e){var r=this,n=e.redux,o=e.models,i=n.combineReducers||p,a=n.createStore||l,c=void 0!==n.initialState?n.initialState:{}
this.reducers=n.reducers,this.mergeReducers=function(e){return void 0===e&&(e={}),r.reducers=t({},r.reducers,e),Object.keys(r.reducers).length?i(r.reducers):function(e){return e}},this.createModelReducer=function(e){for(var t={},n=0,o=Object.keys(e.reducers||{});n<o.length;n++){var i=o[n],a=g(i)?i:e.name+"/"+i
t[a]=e.reducers[i]}r.reducers[e.name]=function(r,n){return void 0===r&&(r=e.state),"function"==typeof t[n.type]?t[n.type](r,n.payload,n.meta):r}}
for(var u=0,s=o;u<s.length;u++)this.createModelReducer(s[u])
this.createRootReducer=function(e){void 0===e&&(e={})
var t=r.mergeReducers()
return Object.keys(e).length?function(r,n){return t(e[n.type]?(0,e[n.type])(r,n):r,n)}:t}
var d=this.createRootReducer(n.rootReducers),f=b.apply(m,n.middlewares),h=w(n.devtoolOptions).apply(void 0,n.enhancers.concat([f]))
return this.store=a(d,c,h),this}.call(this,{redux:this.config.redux,models:this.models}),i=t({name:this.config.name},o.store,{model:function(t){e.addModel(t),o.mergeReducers(o.createModelReducer(t)),o.store.replaceReducer(o.createRootReducer(e.config.redux.rootReducers)),o.store.dispatch({type:"@@redux/REPLACE "})}})
return this.forEachPlugin("onStoreCreated",function(e){var t=e(i)
t&&Object.keys(t||{}).forEach(function(e){i[e]=t[e]})}),i},e}(),E=function(e){console.warn(e)},S=function(e,r){return r?t({},r,e||{}):e||{}}
var j=0,R=function(e){void 0===e&&(e={})
var r=e.name||""+j
j+=1
var n=function(e){for(var r=t({name:e.name,models:{},plugins:[]},e,{redux:t({reducers:{},rootReducers:{},enhancers:[],middlewares:[]},e.redux,{devtoolOptions:t({name:e.name},e.redux&&e.redux.devtoolOptions?e.redux.devtoolOptions:{})})}),n=0,o=r.plugins;n<o.length;n++){var i=o[n]
if(i.config){var a=S(r.models,i.config.models)
r.models=a,r.plugins=r.plugins.concat(i.config.plugins||[]),i.config.redux&&(r.redux.initialState=S(r.redux.initialState,i.config.redux.initialState),r.redux.reducers=S(r.redux.reducers,i.config.redux.reducers),r.redux.rootReducers=S(r.redux.rootReducers,i.config.redux.reducers),r.redux.enhancers=r.redux.enhancers.concat(i.config.redux.enhancers||[]),r.redux.middlewares=r.redux.middlewares.concat(i.config.redux.middlewares||[]),r.redux.combineReducers=r.redux.combineReducers||i.config.redux.combineReducers,r.redux.createStore=r.redux.createStore||i.config.redux.createStore)}}return r}(t({},e,{name:r}))
return new O(n).init()},_={init:R}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__rematch_core__ = __webpack_require__("./node_modules/@rematch/core/dist/umd/rematch.js");
